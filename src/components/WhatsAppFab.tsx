...
export function WhatsAppFab() {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-gold-gradient text-cocoa-deep shadow-gold-glow transition-transform hover:scale-110"
      aria-label="WhatsApp"
    >
